...
command! -addr=arguments -bang -range=% -nargs=?                      ArgsKeepMatchingBuffers if ! ArgsAndMore#Args#Filter('ArgsAndMore#Args#KeepMatchingBuffers', <q-bang>, <line1>, <line2>, <q-args>) | echoerr ingo#err#Get() | endif
command! -addr=arguments -bang -range=% -nargs=?                      ArgsDeleteMatchingBuffers if ! ArgsAndMore#Args#Filter('ArgsAndMore#Args#DeleteMatchingBuffers', <q-bang>, <line1>, <line2>, <q-args>) | echoerr ingo#err#Get() | endif
...
command!                 -bang -range=% -nargs=?                      ArgsKeepMatchingBuffers if ! ArgsAndMore#Args#Filter('KeepMatchingBuffers', <q-bang>, <line1>, <line2>, <q-args>) | echoerr ingo#err#Get() | endif
command!                 -bang -range=% -nargs=?                      ArgsDeleteMatchingBuffers if ! ArgsAndMore#Args#Filter('DeleteMatchingBuffers', <q-bang>, <line1>, <line2>, <q-args>) | echoerr ingo#err#Get() | endif
